...
async function getInputValue() {
    ...
    if (value === "about") {
        ...
        trueValue(value);
        window.open('https://github.com/whoisyoges/website-cli', '_blank');
        createText("<a href='https://github.com/whoisyoges/website-cli' target='_blank' rel='noopener noreferrer'> github.com/whoisyoges/website-cli</a>")
