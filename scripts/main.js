...
function help() {
    createText("Available commands: <span class='blue'>about</span>, <span class='blue'>clear</span>, <span class='blue'>codeberg</span>, <span class='blue'>cv</span>, <span class='blue'>date</span>, <span class='blue'>donate</span>, <span class='blue'>email</span>, <span class='blue'>exit</span>, <span class='blue'>github</span>, <span class='blue'>gui</span>, <span class='blue'>help</span>, <span class='blue'>ls</span>, <span class='blue'>ls -l</span>, <span class='blue'>mastodon</span>, <span class='blue'>resume</span>, <span class='blue'>sourcehut</span>, <span class='blue'>twitter</span>, <span class='blue'>whoami</span>, <span class='blue'>youtube</span>");
}
...
async function getInputValue() {
    ...
    if (value === "about") {
        ...
        trueValue(value);
        createText("<a href='https://castorisdead.xyz/donate' target='_blank' rel='noopener noreferrer'> castorisdead.xyz/donate</a>");
        window.open('https://castorisdead.xyz/donate', '_blank');
    } else if (value === "email") {
        trueValue(value);
        ...
        createText("<a href='https://git.sr.ht/~whoisyoges' target='_blank' rel='noopener noreferrer'> git.sr.ht/~whoisyoges</a>")
        ...
        falseValue(value);
        createText(`${value}: command not found<br>Type <span class='blue'>ls</span> to see the list of available commands.<br>Remember all the commands are case sensitive.`)
    }
}
