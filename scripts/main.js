...
async function getInputValue(){
  ...
  if(value === "about"){
    ...
    trueValue(value);
    createText("<a href='https://yogeshlamichhane.com.np' target='_blank' rel='noopener noreferrer'> https://yogeshlamichhane.com.np</a>")
  }
  else if(value === "help"){
    trueValue(value);
    help();
    ...
    trueValue(value);
    createText("Available commands: <br><span class='blue'>about</span>, <span class='blue'>clear</span>, <span class='blue'>codeberg</span>, <span class='blue'>cv</span>, <span class='blue'>date</span>, <span class='blue'>email</span>, <span class='blue'>exit</span>, <span class='blue'>github</span>, <span class='blue'>gui</span>, <span class='blue'>help</span>, <span class='blue'>instagram</span>, <span class='blue'>linkedin</span>, <span class='blue'>ls</span>, <span class='blue'>ls -l</span>, <span class='blue'>resume</span>, <span class='blue'>twitter</span>, <span class='blue'>whoami</span>, <span class='blue'>youtube</span>"); 
  }
  else if(value === "ls -l"){
    trueValue(value);
    createText("Available commands with description: <br> <p class='lsall'><span class='blue lstitle'>about </span> <span class='desc'> short about whoisYoges </span> </p>  <p class='lsall'><span class='blue lstitle'>clear </span>  <span class='desc'> clear the terminal screen </span> </p>  <p class='lsall'><span class='blue lstitle'>codeberg </span>  <span class='desc'> link to my personal projects git repo </span> </p> <p class='lsall'><span class='blue lstitle'>cv </span>  <span class='desc'> link to my cv </span> </p> <p class='lsall'><span class='blue lstitle'>date </span>  <span class='desc'> current date </span> </p> <p class='lsall'><span class='blue lstitle'>email </span>  <span class='desc'> email address to contact me </span> </p> <p class='lsall'><span class='blue lstitle'>exit </span>  <span class='desc'> exit from the terminal </span> </p> <p class='lsall'><span class='blue lstitle'>github </span>  <span class='desc'> link to my work projects git repo </span> </p> <p class='lsall'><span class='blue lstitle'>gui </span>  <span class='desc'> link to my gui (normal) website </span> </p> <p class='lsall'><span class='blue lstitle'>help </span>  <span class='desc'> show help text to get started with this site </span> </p> <p class='lsall'><span class='blue lstitle'>instagram </span>  <span class='desc'> link to my instagram profile </span> </p> <p class='lsall'><span class='blue lstitle'>linkedin </span>  <span class='desc'> link to my linkedin profile </span> </p> <p class='lsall'><span class='blue lstitle'>ls </span>  <span class='desc'> list all the available commands in this site </span> </p> <p class='lsall'><span class='blue lstitle'>resume </span>  <span class='desc'> link to my resume </span> </p> <p class='lsall'><span class='blue lstitle'>twitter </span>  <span class='desc'> link to my twitter profile </span> </p> <p class='lsall'><span class='blue lstitle'>whoami </span>  <span class='desc'> who are you? </span> </p> <p class='lsall'><span class='blue lstitle'>youtube </span>  <span class='desc'> link to my youtube profile"); 
  }
